...
function generateRandomItem(index) {
    ...
    // High-quality placeholder images from LoremFlickr using category matching
    const imageUrl = `https://loremflickr.com/1200/800/${cat.keywords.split(',')[0]}?lock=${index}`;
...
export async function runStressTestSeeder(count = 2000) {
    ...
    for (let i = 0; i < batches; i++) {
        ...
        // Transform to match DB structure (data column)
